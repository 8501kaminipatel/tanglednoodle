...
const Product1 = () => {
    ...
    const getdata = () => {
        axios
            .get(' http://localhost:5000/men2', { params: parmobj })
            .then(response => {
                ...
                <div className="sidebar">
                    <div className="filter">
                        ...
                        <div className="filter-checkbox">
                            ...
                            <label>
                                <input type="checkbox" value="Slim Fit Casual Shirt"
                                    checked={selectedProductNames.includes("Slim Fit Casual Shirt")}
                                    onChange={handleProductNameChange} /> Slim Fit Casual Shirt
                            </label><br />
                            <label>
                                <input type="checkbox" value="Oversized T-shirt & Joggers"
                                    checked={selectedProductNames.includes("Oversized T-shirt & Joggers")}
                                    onChange={handleProductNameChange} /> Oversized T-shirt & Joggers
                            </label><br />
                            <label>
                                <input type="checkbox" value="Men Mid Rise Cotton Cargos"
                                    checked={selectedProductNames.includes("Men Mid Rise Cotton Cargos")}
                                    onChange={handleProductNameChange} />
                                Men Mid Rise Cotton Cargos
                            </label><br />
                            <label>
                                <input type="checkbox" value="Oversized Textured Co-ord Set"
                                    checked={selectedProductNames.includes("Oversized Textured Co-ord Set")}
                                    onChange={handleProductNameChange} />
                                Oversized Textured Co-ord Set
                            </label><br />
                            <label>
                                <input type="checkbox" value="Slim Fit Cotton Shirt"
                                    checked={selectedProductNames.includes("Slim Fit Cotton Shirt")}
                                    onChange={handleProductNameChange} />
                                Slim Fit Cotton Shirt
                            </label><br />
                            <label>
                                <input type="checkbox" value="Opaque Casual Shirt"
                                    checked={selectedProductNames.includes("Opaque Casual Shirt")}
                                    onChange={handleProductNameChange} />
                                Opaque Casual Shirt
                            </label><br />
                            <label>
                                <input type="checkbox" value="Men Striped Shorts"
                                    checked={selectedProductNames.includes("Men Striped Shorts")}
                                    onChange={handleProductNameChange} />
                                Men Striped Shorts
                            </label><br />
                            <label>
                                <input type="checkbox" value="Striped Cotton Linen Shirt"
                                    checked={selectedProductNames.includes("Striped Cotton Linen Shirt")}
                                    onChange={handleProductNameChange} />
                        ...
                        <div className="filter-brand">
                            ...
                            <label>
                                <input type="checkbox" value="THE BEAR HOUSE"
                                    checked={selectedBrands.includes("THE BEAR HOUSE")}
                                    onChange={handleBrandChange} /> THE BEAR HOUSE
                            </label><br />
                            <label>
                                <input type="checkbox" value="NOBERO"
                                    checked={selectedBrands.includes("NOBERO")}
                                    onChange={handleBrandChange} /> NOBERO
                            </label><br />
                            <label>
                                <input type="checkbox" value="CINOCCI"
                                    checked={selectedBrands.includes("CINOCCI")}
                                    onChange={handleBrandChange} /> CINOCCI
                            </label><br />
                            <label>
                                <input type="checkbox" value="Mufti"
                                    checked={selectedBrands.includes("Mufti")}
                                    onChange={handleBrandChange} />
                                Mufti
                            </label><br />
                            <label>
                                <input type="checkbox" value="Maniac"
                                    checked={selectedBrands.includes("Maniac")}
                                    onChange={handleBrandChange} /> Maniac
                            </label><br />
                            <label>
                                <input type="checkbox" value="Urbano Fashion"
                                    checked={selectedBrands.includes("Urbano Fashion")}
                                    onChange={handleBrandChange} /> Urbano Fashion
                            </label><br />
                            <label>
                                <input type="checkbox" value="Powerlook"
                                    checked={selectedBrands.includes("Powerlook")}
                                    onChange={handleBrandChange} />
                                Powerlook
                            </label><br />
