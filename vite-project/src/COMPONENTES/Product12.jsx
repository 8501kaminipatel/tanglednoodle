...
const Product12 = () => {
  ...
  const getdata = () => {
    axios
      .get(' http://localhost:5000/men13', { params: parmobj })
      .then(response => {
        ...
        <div className="sidebar">
          <div className="filter">
            ...
            <div className="filter-checkbox">
              ...
              <label>
                <input type="checkbox" value="Unisex Back To School Shoes"
                  checked={selectedProductNames.includes("Unisex Back To School Shoes")}
                  onChange={handleProductNameChange} /> Unisex Back To School Shoes
              </label><br />
              <label>
              ...
              <label>
                <input type="checkbox" value="Solid Formal Oxfords"
                  checked={selectedProductNames.includes("Solid Formal Oxfords")}
                  onChange={handleProductNameChange} /> Solid Formal Oxfords
              </label><br />
              <label>
                <input type="checkbox" value="Men Formal Slip On Shoes"
                  checked={selectedProductNames.includes("Men Formal Slip On Shoes")}
                  onChange={handleProductNameChange} /> Men Formal Slip On Shoes
              </label><br />
              <label>
                <input type="checkbox" value="Men Colourblocked Sneakers"
                  checked={selectedProductNames.includes("Men Colourblocked Sneakers")}
                  onChange={handleProductNameChange} /> Men Colourblocked Sneakers
              </label><br />
              <label>
                <input type="checkbox" value="Men Textured Formal Oxfords"
                  checked={selectedProductNames.includes("Men Textured Formal Oxfords")}
                  onChange={handleProductNameChange} /> Men Textured Formal Oxfords
              </label><br />
            ...
            <div className="filter-brand">
              ...
              <label>
                <input type="checkbox" value="INVICTUS"
                  checked={selectedBrands.includes("INVICTUS")}
                  onChange={handleBrandChange} /> INVICTUS
              </label><br />

              <label>
                <input type="checkbox" value="Bata"
                  checked={selectedBrands.includes("Bata")}
                  onChange={handleBrandChange} /> Bata
              </label><br />
