...
const Product14 = () => {
  ...
  const getdata = () => {
    axios
      .get(' http://localhost:5000/men15', { params: parmobj })
      .then(response => {
  ...
  return (
    <>
        ...
        <div className="sidebar">
          <div className="filter">
            <div className="filter-radio d-flex flex-column">
              ...
              <hr />
              <label htmlFor="men">
                <input type="checkbox" value="sports shoes" checked={categorydata.includes("sports shoes")} onChange={handlechange} />
                sports shoes
              </label>

              <label htmlFor="men">
                <input type="checkbox" value="track pants" checked={categorydata.includes("track pants")} onChange={handlechange} />
                track pants
              </label>

              <label htmlFor="men">
                <input type="checkbox" value="tracksuits" checked={categorydata.includes("tracksuits")} onChange={handlechange} />
                tracksuits
              </label>

              <label htmlFor="men">
                <input type="checkbox" value="shorts" checked={categorydata.includes("shorts")} onChange={handlechange} />
                shorts </label>
            </div>
            <hr />
            ...
            <div className="filter-checkbox">
              ...
              <label>
                <input type="checkbox" value="Unisex Running Shoes"
                  checked={selectedProductNames.includes("Unisex Running Shoes")}
                  onChange={handleProductNameChange} /> Unisex Running Shoes
              </label><br />

              <label>
                <input type="checkbox" value="Men Running Shoes"
                  checked={selectedProductNames.includes("Men Running Shoes")}
                  onChange={handleProductNameChange} /> Men Running Shoes
              </label><br />

              <label>
                <input type="checkbox" value="Men Mid Rise Track Pants"
                  checked={selectedProductNames.includes("Men Mid Rise Track Pants")}
                  onChange={handleProductNameChange} /> Men Mid Rise Track Pants
              </label><br />

              <label>
                <input type="checkbox" value="Rapid-Dry Striped Tracksuit"
                  checked={selectedProductNames.includes("Rapid-Dry Striped Tracksuit")}
                  onChange={handleProductNameChange} /> Rapid-Dry Striped Tracksuit
              </label><br />

              <label>
                <input type="checkbox" value="Unisex Badminton Indoor Shoes"
                  checked={selectedProductNames.includes("Unisex Badminton Indoor Shoes")}
                  onChange={handleProductNameChange} /> Unisex Badminton Indoor Shoes
              </label><br />

              <label>
                <input type="checkbox" value="Men Rapid-Dry Running Shorts"
                  checked={selectedProductNames.includes("Men Rapid-Dry Running Shorts")}
                  onChange={handleProductNameChange} /> Men Rapid-Dry Running Shorts
              </label><br />

              <label>
                <input type="checkbox" value="Men Go Run Consistent Shoes"
                  checked={selectedProductNames.includes("Men Go Run Consistent Shoes")}
                  onChange={handleProductNameChange} /> Men Go Run Consistent Shoes
              </label><br />

              <label>
                <input type="checkbox" value="Men Sports Shorts"
                  checked={selectedProductNames.includes("Men Sports Shorts")}
                  onChange={handleProductNameChange} /> Men Sports Shorts
              </label><br />
            ...
            <div className="filter-brand">
              ...
              <label>
                <input type="checkbox" value="WROGN"
                  checked={selectedBrands.includes("WROGN")}
                  onChange={handleBrandChange} /> WROGN
              </label><br />

              <label>
                <input type="checkbox" value="TURNFIT"
                  checked={selectedBrands.includes("TURNFIT")}
                  onChange={handleBrandChange} /> TURNFIT
              </label><br />
              ...
              <label>
                <input type="checkbox" value="Red Tape"
                  checked={selectedBrands.includes("Red Tape")}
                  onChange={handleBrandChange} /> Red Tape
              </label><br />

              <label>
                <input type="checkbox" value="Campus"
                  checked={selectedBrands.includes("Campus")}
                  onChange={handleBrandChange} /> Campus
              </label><br />

              <label>
                <input type="checkbox" value="Skechers"
                  checked={selectedBrands.includes("Skechers")}
                  onChange={handleBrandChange} /> Skechers
              </label><br />
      ...
      <div className="recently-viewed-link">
  <Link to="/recently-viewed">See Recently Viewed Products</Link>
</div>
    </>
  );
};
