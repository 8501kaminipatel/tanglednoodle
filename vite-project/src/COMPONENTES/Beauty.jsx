...
const Beauty = () => {
  ...
  const handleDiscountChange = (e) => {
    ...
    setDiscountFilters([value]); // only one selected
    setSearchParams({ ...searchParams, discount: value }); // update URL
  };
  ...
  useEffect(() => {
    ...
    getdata(); // Fetch data when URL search parameters change
  }, [location.search, ascproduct, searchParams, discountFilters]);
