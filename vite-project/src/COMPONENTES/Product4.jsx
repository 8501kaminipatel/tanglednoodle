        ...
        <div className="sidebar">
          <div className="filter">
            ...
            <div className="filter-checkbox">
              ...
              <label>
                <input type="checkbox" value="Tartan Checked Shacket"
                  checked={selectedProductNames.includes("Tartan Checked Shacket")}
                  onChange={handleProductNameChange} />
                Tartan Checked Shacket
              </label><br />

              <label>
                <input type="checkbox" value="Men Regular Fit Cotton Trouser"
                  checked={selectedProductNames.includes("Men Regular Fit Cotton Trouser")}
                  onChange={handleProductNameChange} />
                Men Regular Fit Cotton Trouser
              </label><br />

              <label>
                <input type="checkbox" value="Casual Shirt with Roll-Up Tabs"
                  checked={selectedProductNames.includes("Casual Shirt with Roll-Up Tabs")}
                  onChange={handleProductNameChange} />
                Casual Shirt with Roll-Up Tabs
              </label><br />

              <label>
                <input type="checkbox" value="Pure Cotton Relaxed T-shirt"
                  checked={selectedProductNames.includes("Pure Cotton Relaxed T-shirt")}
                  onChange={handleProductNameChange} />
                Pure Cotton Relaxed T-shirt
              </label><br />

              <label>
                <input type="checkbox" value="Plus Size Round Neck T-shirt"
                  checked={selectedProductNames.includes("Plus Size Round Neck T-shirt")}
                  onChange={handleProductNameChange} />
                Plus Size Round Neck T-shirt
              </label><br />

              <label>
                <input type="checkbox" value="Plus Size Cotton Casual Shirt"
                  checked={selectedProductNames.includes("Plus Size Cotton Casual Shirt")}
                  onChange={handleProductNameChange} />
                Plus Size Cotton Casual Shirt
              </label><br />

              <label>
                <input type="checkbox" value="Men Tapered Fit Jeans"
                  checked={selectedProductNames.includes("Men Tapered Fit Jeans")}
                  onChange={handleProductNameChange} />
                Men Tapered Fit Jeans
              </label><br />

              <label>
                <input type="checkbox" value="Pure Cotton Casual Shirt"
                  checked={selectedProductNames.includes("Pure Cotton Casual Shirt")}
                  onChange={handleProductNameChange} />
            ...
            <div className="filter-brand">
              ...
              <label>
                <input type="checkbox" value="Cantabil"
                  checked={selectedBrands.includes("Cantabil")}
                  onChange={handleBrandChange} />
                Cantabil
              </label><br />

              <label>
                <input type="checkbox" value="Nautica"
                  checked={selectedBrands.includes("Nautica")}
                  onChange={handleBrandChange} />
                Nautica
              </label><br />
              ...
              <label>
                <input type="checkbox" value="Flying Machine"
                  checked={selectedBrands.includes("Flying Machine")}
                  onChange={handleBrandChange} />
                Flying Machine
              </label><br />

              <label>
                <input type="checkbox" value="Sztori"
                  checked={selectedBrands.includes("Sztori")}
                  onChange={handleBrandChange} />
                Sztori
              </label><br />

              <label>
                <input type="checkbox" value="SPYKAR"
                  checked={selectedBrands.includes("SPYKAR")}
                  onChange={handleBrandChange} />
                SPYKAR
              </label><br />

              <label>
                <input type="checkbox" value="Jack & Jones"
                  checked={selectedBrands.includes("Jack & Jones")}
                  onChange={handleBrandChange} />
                Jack & Jones
              </label><br />
