        ...
        <div className="sidebar">
          <div className="filter">
            ...
            <div className="filter-checkbox">
              ...
              <label>
                <input type="checkbox" value="Relaxed-Fit Regular Trousers"
                  checked={selectedProductNames.includes("Relaxed-Fit Regular Trousers")}
                  onChange={handleProductNameChange} /> Relaxed-Fit Regular Trousers
              </label><br />
              ...
              <label>
                <input type="checkbox" value="Men Cargos Trousers"
                  checked={selectedProductNames.includes("Men Cargos Trousers")}
                  onChange={handleProductNameChange} /> Men Cargos Trousers
              </label><br />

              <label>
                <input type="checkbox" value="Men Slim Fit Trousers"
                  checked={selectedProductNames.includes("Men Slim Fit Trousers")}
                  onChange={handleProductNameChange} /> Men Slim Fit Trousers
              </label><br />

              <label>
                <input type="checkbox" value="Men Tapered Fit Chinos"
                  checked={selectedProductNames.includes("Men Tapered Fit Chinos")}
                  onChange={handleProductNameChange} /> Men Tapered Fit Chinos
              </label><br />

              <label>
                <input type="checkbox" value="Men Loose Fit Trousers"
                  checked={selectedProductNames.includes("Men Loose Fit Trousers")}
                  onChange={handleProductNameChange} /> Men Loose Fit Trousers
              </label><br />
            ...
            <div className="filter-brand">
              ...
              <label>
                <input type="checkbox" value="IVOC"
                  checked={selectedBrands.includes("IVOC")}
                  onChange={handleBrandChange} /> IVOC
              </label><br />

              <label>
                <input type="checkbox" value="Allen Solly"
                  checked={selectedBrands.includes("Allen Solly")}
                  onChange={handleBrandChange} /> Allen Solly
              </label><br />

              <label>
                <input type="checkbox" value="Bonkers Corner"
                  checked={selectedBrands.includes("Bonkers Corner")}
                  onChange={handleBrandChange} /> Bonkers Corner
              </label><br />
