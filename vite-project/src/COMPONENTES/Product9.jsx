...
const Product9 = () => {
  ...
  const getdata = () => {
    axios
      .get(' http://localhost:5000/men10', { params: parmobj })
      .then(response => {
        ...
        <div className="sidebar">
          <div className="filter">
            ...
            <div className="filter-checkbox">
              ...
              <label>
                <input type="checkbox" value="Striped Cotton Short Kurta"
                  checked={selectedProductNames.includes("Striped Cotton Short Kurta")}
                  onChange={handleProductNameChange} />
                Striped Cotton Short Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Embroidered Straight Kurta"
                  checked={selectedProductNames.includes("Embroidered Straight Kurta")}
                  onChange={handleProductNameChange} />
                Embroidered Straight Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Men Short Kurta"
                  checked={selectedProductNames.includes("Men Short Kurta")}
                  onChange={handleProductNameChange} />
                Men Short Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Men Printed Cotton Kurta"
                  checked={selectedProductNames.includes("Men Printed Cotton Kurta")}
                  onChange={handleProductNameChange} />
                Men Printed Cotton Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Pure Cotton Striped Kurta"
                  checked={selectedProductNames.includes("Pure Cotton Striped Kurta")}
                  onChange={handleProductNameChange} />
                Pure Cotton Striped Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Pure Cotton Straight Kurta"
                  checked={selectedProductNames.includes("Pure Cotton Straight Kurta")}
                  onChange={handleProductNameChange} />
                Pure Cotton Straight Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Embroidered Cotton Silk Kurta"
                  checked={selectedProductNames.includes("Embroidered Cotton Silk Kurta")}
                  onChange={handleProductNameChange} />
                Embroidered Cotton Silk Kurta
              </label><br />

              <label>
                <input type="checkbox" value="Men Embroidered Kurta"
                  checked={selectedProductNames.includes("Men Embroidered Kurta")}
                  onChange={handleProductNameChange} />
            ...
            <div className="filter-brand">
              ...
              <label>
                <input type="checkbox" value="HERE&NOW"
                  checked={selectedBrands.includes("HERE&NOW")}
                  onChange={handleBrandChange} /> HERE&NOW
              </label><br />

              <label>
                <input type="checkbox" value="Jompers"
                  checked={selectedBrands.includes("Jompers")}
                  onChange={handleBrandChange} /> Jompers
              </label><br />

              <label>
                <input type="checkbox" value="House of Pataudi"
                  checked={selectedBrands.includes("House of Pataudi")}
                  onChange={handleBrandChange} /> House of Pataudi
              </label><br />

              <label>
                <input type="checkbox" value="KINGDOM OF WHITE"
                  checked={selectedBrands.includes("KINGDOM OF WHITE")}
                  onChange={handleBrandChange} /> KINGDOM OF WHITE
              </label><br />

              <label>
                <input type="checkbox" value="Sangria"
                  checked={selectedBrands.includes("Sangria")}
                  onChange={handleBrandChange} /> Sangria
              </label><br />

              <label>
                <input type="checkbox" value="FILORI"
                  checked={selectedBrands.includes("FILORI")}
                  onChange={handleBrandChange} /> FILORI
              </label><br />

              <label>
                <input type="checkbox" value="KISAH"
                  checked={selectedBrands.includes("KISAH")}
                  onChange={handleBrandChange} /> KISAH
              </label><br />
