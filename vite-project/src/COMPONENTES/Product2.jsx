...
const Product2 = () => {
    ...
    const getdata = () => {
        axios
            .get(' http://localhost:5000/men3', { params: parmobj })
            .then(response => {
                ...
                <div className="sidebar">
                    <div className="filter">
                        ...
                        <div className="filter-checkbox">
                            ...
                            <label>
                                <input type="checkbox" value="Men Analogue and Digital Watch"
                                    checked={selectedProductNames.includes("Men Analogue and Digital Watch")}
                                    onChange={handleProductNameChange} />
                                Men Analogue and Digital Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Men Analogue Watch"
                                    checked={selectedProductNames.includes("Men Analogue Watch")}
                                    onChange={handleProductNameChange} /> Men Analogue Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Men Leather Straps Watch"
                                    checked={selectedProductNames.includes("Men Leather Straps Watch")}
                                    onChange={handleProductNameChange} /> Men Leather Straps Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Unisex Analogue Watch"
                                    checked={selectedProductNames.includes("Unisex Analogue Watch")}
                                    onChange={handleProductNameChange} />
                                Unisex Analogue Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Unisex Analogue Watch 1190G"
                                    checked={selectedProductNames.includes("Unisex Analogue Watch 1190G")}
                                    onChange={handleProductNameChange} />
                                Unisex Analogue Watch 1190G
                            </label><br />
                            <label>
                                <input type="checkbox" value="Unisex Digital Watch"
                                    checked={selectedProductNames.includes("Unisex Digital Watch")}
                                    onChange={handleProductNameChange} /> Unisex Digital Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Stainless Steel Straps Watch"
                                    checked={selectedProductNames.includes("Stainless Steel Straps Watch")}
                                    onChange={handleProductNameChange} />
                                Stainless Steel Straps Watch
                            </label><br />
                            <label>
                                <input type="checkbox" value="Men Analogue & Digital Watch"
                                    checked={selectedProductNames.includes("Men Analogue & Digital Watch")}
                                    onChange={handleProductNameChange} /> Men Analogue & Digital Watch
                            </label><br />
                        ...
                        <div className="filter-brand">
                            ...
                            <label>
                                <input type="checkbox" value="Mast & Harbour"
                                    checked={selectedBrands.includes("Mast & Harbour")}
                                    onChange={handleBrandChange} />
                                Mast & Harbour
                            </label><br />

                            <label>
                                <input type="checkbox" value="French Connection"
                                    checked={selectedBrands.includes("French Connection")}
                                    onChange={handleBrandChange} />
                                French Connection
                            </label><br />

                            <label>
                                <input type="checkbox" value="Deve Herbes(1986)"
                                    checked={selectedBrands.includes("Deve Herbes(1986)")}
                                    onChange={handleBrandChange} />
                                Deve Herbes(1986)
                            </label><br />

                            <label>
                                <input type="checkbox" value="REACTION KENNETH COLE"
                                    checked={selectedBrands.includes("REACTION KENNETH COLE")}
                                    onChange={handleBrandChange} />
                        ...
                        <div className="filter-color d-flex flex-column">
                            ...
                            <label>
                                <input type="checkbox" value="silver"
                                    ...
                                    onChange={handleColorChange} />
                                <i className="bi bi-circle-fill" style={{ color: "#C0C0C0", padding: "5px" }}></i> silver (6392)
                            </label>
