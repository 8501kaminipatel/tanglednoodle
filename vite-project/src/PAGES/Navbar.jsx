    ...
    <>
        <div className="header">
            <div className="container-fluid">
                <div className="row">
                    <div
                        className="navbar navbar-expand-lg p-0 m-0 position-fixed top-0 bg-light"
                        ...
                        <div className="collapse navbar-collapse d-flex justify-content-around">
                            ...
                            >
                                ...
                                <li className="nav-item list2">
                                    <Link to="/women" className="nav-link text-dark">WOMEN</Link>
                                ...
                                <li className="nav-item list3">
                                    <Link to="/kids" className="nav-link text-dark">KIDS</Link>
